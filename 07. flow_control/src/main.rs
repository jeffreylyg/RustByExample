fn main() {
    ...
    _loop(); //7.2
    println!("");
    loop_nesting_and_labels(); //7.2.1
    println!("");
    loop_returning_from_loops(); //7.2.2
    println!("");
    _while(); //7.3
    println!("");
    for_and_range(); //7.4
    ...
    _match(); //7.5
    println!("");
    match_destructuring_tuples(); //7.5.1.1
    println!("");
    match_destructuring_enums(); //7.5.1.2
    println!("");
    match_destructuring_pointers_ref(); //7.5.1.3
    println!("");
    match_destructuring_structs(); //7.5.1.4
    println!("");
    match_destructuring_guards(); //7.5.2
    println!("");
    match_destructuring_binding(); //7.5.3
    println!("");
    if_let(); //7.6
    println!("");
    while_let();
...
fn match_destructuring_pointers_ref() {
 ...
 */
fn match_destructuring_binding() {
    fn age() -> u32 {
        9
    }
